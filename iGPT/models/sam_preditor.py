...
class SamPredictor:
    ...
    def predict(
        ...
        if point_coords is not None:
            ...
            point_coords = self.transform.apply_coords(point_coords, features['original_size'])
    ...
    def predict_torch(
        ...
        masks = self.model.postprocess_masks(low_res_masks, features['input_size'], features['original_size'])
